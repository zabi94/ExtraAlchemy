...
public class CraftingRecipes {
	...
	public static void init() {
		...
		ALT_RING_CRAFTING_SERIALIZER = Registry.register(Registry.RECIPE_SERIALIZER, LibMod.id("alt_potion_ring"), new AlternativePotionRingRecipe.Serializer());
		ALT_RING_CRAFTING_TYPE = Registry.register(Registry.RECIPE_TYPE, LibMod.id("alt_potion_ring"), new RecipeType<AlternativePotionRingRecipe>() {});
	}
