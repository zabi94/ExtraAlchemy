...
public class ModConfig {
	...
	public static boolean removeInventoryPotionShift;
	...
	public static void loadDefaults() {
		ModConfig.removeInventoryPotionShift = true;
	}
		...
		if (folder.isDirectory()) {
			...
			if (!configFile.exists()) {
				try {
					...
					ConfigInstance def = new ConfigInstance(removeInventoryPotionShift);
	...
	public static void readJson() {
		try {
			...
			removeInventoryPotionShift = instance.removeInventoryPotionShift;
			Log.i("removeInventoryPotionShift: "+removeInventoryPotionShift);
