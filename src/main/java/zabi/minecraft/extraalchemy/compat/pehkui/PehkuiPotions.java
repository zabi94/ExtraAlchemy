...
//
//	public static ModPotion shrinking_ = ModPotion.ModPotionTimed.generateAll("shrinking", Registries.STATUS_EFFECT.getEntry(shrinking), 20*120, 20*240, 20*60);
//	public static ModPotion growing_ = ModPotion.ModPotionTimed.generateAll("growing", Registries.STATUS_EFFECT.getEntry(growing), 20*120, 20*240, 20*60);
//	
...
//		BrewingRecipes.registerPotion(builder, ModConfig.INSTANCE.potions.shrinking, shrinking_, Items.BROWN_MUSHROOM, Potions.AWKWARD);
//		BrewingRecipes.registerPotion(builder, ModConfig.INSTANCE.potions.growing, growing_, Items.RED_MUSHROOM, Potions.AWKWARD);
//	}
