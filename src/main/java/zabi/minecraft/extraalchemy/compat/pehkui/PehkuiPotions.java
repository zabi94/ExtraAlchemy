...
public class PehkuiPotions {
	...
	public static int registerPotions() {
		shrinking_ = ModPotion.ModPotionTimed.generateAll("shrinking", Registries.STATUS_EFFECT.getEntry(shrinking), 20*120, 20*240, 20*60);
		growing_ = ModPotion.ModPotionTimed.generateAll("growing", Registries.STATUS_EFFECT.getEntry(growing), 20*120, 20*240, 20*60);
