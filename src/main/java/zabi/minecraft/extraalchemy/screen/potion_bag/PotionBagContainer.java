...
public class PotionBagContainer extends Container {

	protected PotionBagItem.BagInventory bagInventory;
	protected ItemStack bagStack;
	protected PlayerInventory playerInventory;

	public PotionBagContainer(int syncId, PlayerInventory playerInventory, PlayerEntity player, Hand hand) {
		super(null, syncId);
	...
	public PotionBagContainer(int syncId, PlayerInventory playerInventory) {
	...
	public void close(PlayerEntity player) {
		bagInventory.onInvClose(player);
